...
//
#ifndef __RDF_LTD__CustomModel_H
#define __RDF_LTD__CustomModel_H
...
namespace CustomModel
{
    ...
    /// You also can use object of this C++ class instead of int64_t handle of the OWL instance in any place where the handle is required
    /// </summary>
    class MyCustomCylinder : public Cylinder
    {
    public:
        /// <summary>
        ...
        /// <param name="name">This attribute represents the name of the instance (given as char array / ASCII). The name is given by the host and the attribute is not changed</param>
        /// <returns></returns>
        static MyCustomCylinder Create(int64_t model, const char* name=NULL) { return MyCustomCylinder(Instance::Create(model, "MyCustomCylinder", name), "MyCustomCylinder");}
        ...
        /// <param name="instance">OWL instance to interact with</param>
        /// <param name="checkClassName">Expected OWL class of the instance, used for diagnostic (optionally)</param>
        MyCustomCylinder(int64_t instance = NULL, const char* checkClassName = NULL)
            : Cylinder(instance, (checkClassName != NULL) ? checkClassName : "MyCustomCylinder")
        {}
       ...
       //
        ...
        void set_MyCustomBool(bool* values, int64_t count) { SetDatatypeProperty ("MyCustomBool", values, count); }
        ///<summary>Gets values array of MyCustomBool. OWL cardinality 1..10. The method returns pointer to inernal buffer, a caller should not free or change it.</summary>
        const bool* get_MyCustomBool(int64_t* pCount) { return GetDatatypeProperty<bool>("MyCustomBool", pCount); }
        ///<summary>Sets values of MyCustomString. OWL cardinality 1..10</summary>
        void set_MyCustomString(const char* const* values, int64_t count) { SetDatatypeProperty ("MyCustomString", values, count); }
        ///<summary>Gets values array of MyCustomString. OWL cardinality 1..10. The method returns pointer to inernal buffer, a caller should not free or change it.</summary>
        const char* const* get_MyCustomString(int64_t* pCount) { return GetDatatypeProperty<const char* const>("MyCustomString", pCount); }
    };
