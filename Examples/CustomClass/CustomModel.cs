...
//     World
    ...
    public class MyCustomCylinder : Cylinder
    {
        ...
        /// <param name="name">This attribute represents the name of the instance (given as char array / ASCII). The name is given by the host and the attribute is not changed</param>
        /// <returns></returns>
        public static new MyCustomCylinder Create(Int64 model, string name=null) { return new MyCustomCylinder(Instance.Create(model, "MyCustomCylinder", name), "MyCustomCylinder");}
        ...
        /// <param name="instance">OWL instance to interact with</param>
        /// <param name="checkClassName">Expected OWL class of the instance, used for diagnostic (optionally)</param>
        public MyCustomCylinder(Int64 instance, string checkClassName = null) 
            : base (instance, (checkClassName!=null) ? checkClassName : "MyCustomCylinder") 
        {            
        }
